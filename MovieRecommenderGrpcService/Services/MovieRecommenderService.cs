...
namespace MovieRecommenderGrpcService.Services
{
    ...
    {
        private readonly PredictionEngine<MovieRatingData, MovieRatingPrediction> _predictionEngine;
        public MovieRecommenderService()
        {
            ...
            _predictionEngine = mlContext.Model.CreatePredictionEngine<MovieRatingData, MovieRatingPrediction>(mlModel);
        }
