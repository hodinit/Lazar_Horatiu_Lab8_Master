...
namespace Lazar_Horatiu_Lab8_Master.Controllers
{
    public class MovieController : Controller
    {
        ...
        public MovieController()
        {
            ...
            channel = GrpcChannel.ForAddress("https://localhost:7241");
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Recommend(float userId, float movieId)
        {
            var client = new
